...
public class Constant {
	...
	public final static String SQLITE_URL = "jdbc:sqlite:qtechlottry.db";

	/**
	 * 弹窗类型
	 */
	public final static String ERROR_MESSAGE_DIALOG_TYPE = "错误";
	public final static String INFORMATION_MESSAGE_DIALOG_TYPE = "信息";
	public final static String WARNING_MESSAGE_DIALOG_TYPE = "警告";

	/**
	 * 弹窗信息
	 */
	public final static String LIMIT_PRIZE_TYPE_DIALOG_MESSAGE = "超出软件奖项上限！";
